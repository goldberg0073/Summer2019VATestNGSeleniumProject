...
public class FileUploadTest {
    ...
    public void test() throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("file-upload")).sendKeys("/Users/hichamahloufous/Desktop/login2.html");
        driver.findElement(By.id("file-submit")).click();

        String actual=driver.findElement(By.id("uploaded-files")).getText();
        Assert.assertEquals(actual,"login2.html");
    ...
    public void test2(){
        ...
        String relativePath = "/src/test/resources/login2.html";
        // location of the file within the project
